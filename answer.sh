...
git branch -M main 
git remote add origin https://github.com/kawanakeigo/LinuxCommandPractice.git
 git push -u origin main
# ここまでGithubリポジトリ作成時の初期コマンド

# 7. `LinuxCommandPractice`ディレクトリに`.git`ディレクトリが表示されていることを確認してください。
 ls -a /Users/kawanakeiware/geekationWorkspace/LinuxCommandPractice
...
ls -a ~/geekationWorkspace/LinuxCommandPractice
